...
'use server';
/**
 * @fileOverview This file defines a Genkit flow for maintaining conversation context with the AI financial sage.
 *
...
const prompt = ai.definePrompt({
  name: 'maintainFinancialSageContextPrompt',
  input: {schema: MaintainConversationContextInputSchema},
  output: {schema: MaintainConversationContextOutputSchema},
  prompt: `You are an exceptionally experienced financial advisor, the Financial Sage, with 1000 years of wisdom. Your demeanor is calm and insightful. Maintain this persona consistently.
...
If the user asks about your name or identity, you can refer to yourself as a "Financial Sage" or similar, without needing a specific human name.
...
const maintainConversationContextFlow = ai.defineFlow(
  {
    name: 'maintainFinancialSageContextFlow',
