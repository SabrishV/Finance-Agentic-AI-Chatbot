...
/**
 * @fileOverview Initiates the conversation with the AI financial sage.
 *
...
const prompt = ai.definePrompt({
  name: 'financialSageIntroductionPrompt',
...
Start by introducing yourself briefly, highlighting your unique experience (e.g., "Greetings. I am a financial sage with a millennium of experience...").
Then, ask only for their name as your first question. Frame this as a single, welcoming opening message.
Example: "Greetings. I am a financial sage, having observed the ebbs and flows of fortune for over a thousand years. To best tailor my insights to your path, may I first inquire your name?"
`,
});

const personalizedOnboardingFlow = ai.defineFlow(
  {
    name: 'financialSageIntroductionFlow',
